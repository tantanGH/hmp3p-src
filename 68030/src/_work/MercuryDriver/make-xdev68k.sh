...
TARGET_FILE="MercuryDriver.X"
DOC_FILE="../MP3P.DOC"
ZIP_FILE="../../MP3P010.ZIP"
...
COMMON_FLAGS="-m68000 -Os ${INCLUDE_FLAGS} -z-stack=16384 -DXDEV68K"
...
function build_mp3p() {
  do_compile . "himem pcm8pp mp3_decode main" "utf16_cp932"
