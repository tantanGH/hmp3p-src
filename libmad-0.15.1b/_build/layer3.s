...
_?L2:						
	...
	move.l _rq_table(d1.l*4),d3		
	bfextu d3{#0:#27},d3			
						
	lea _rq_table+2,a0			
	move.b 1(a0,d1.l*4),d1			
	moveq #31,d4				
	and.l d4,d1				
...
_?L76:						
	...
	move.l -6912(a6,d5.l*4),-(sp)		
	move.l 8(a6),-(sp)			
	jbsr _mad_bit_read			
	addq.l #8,sp				
						
	move.l -7080(a6),a0			
	move.b d0,28(a0,a5.l)			
...
_?L119:						
	...
	lea _mad_huff_pair_table,a1		
	move.l (a1,d0.l*8),-7060(a6)		
						
	clr.l d6				
	move.w 4(a1,d0.l*8),d6			
						
	move.w 6(a1,d0.l*8),d0			
	and.l #65535,d0				
	move.l d0,-7036(a6)			
...
_?L124:						
	...
	move.l -7040(a6),a0			
	clr.l d0				
	move.b 20(a0,a2.l),d0			
						
	lea _mad_huff_pair_table,a2		
	move.l (a2,d0.l*8),-7060(a6)		
						
	clr.l d6				
	move.w 4(a2,d0.l*8),d6			
						
	move.w 6(a2,d0.l*8),d0			
	and.l #65535,d0				
	move.l d0,-7036(a6)			
...
_?L151:						
	...
	move.l _mad_huff_quad_table(d0.l*4),-7060(a6)
...
_?L223:						
	...
	move.l -7068(a6),-7080(a6)		
	move.l -7020(a6),d3			
	move.l -7068(a6),-7088(a6)		
	clr.l -7072(a6)				
	moveq #111,d7				
	not.b d7				
...
_?L228:						
	...
	move.l -6988(a6,d0.l*4),d6		
						
	move.l -6976(a6,d0.l*4),a5		
						
	lea (1,a5),a4				
	move.l a4,-6976(a6,d0.l*4)		
	...
	add.l d1,d1				
	add.l a5,d1				
	move.l (a1)+,-6912(a6,d1.l*4)		
						
	moveq #6,d1				
	cmp.l a4,d1				
	jbne _?L229				
						
	clr.l -6976(a6,d0.l*4)			
						
	addq.l #1,d6				
	move.l d6,-6988(a6,d0.l*4)		
_?L229:						
...
_?L214:						
	...
	moveq #12,d6				
	asr.l d6,d1				
	move.w _is_table(d3.l*4),d6		
	ext.l d6				
	muls.l d1,d6				
	move.l d6,(a3)+				
						
	move.w _is_table(d5.l*4),d6		
	ext.l d6				
	muls.l d1,d6				
	move.l d6,2300(a3)			
...
_?L366:						
	...
	move.l d6,d0				
	movem.l -324(a6),d3/d4/d5/d6/d7/a3/a4/a5
	unlk a6					
	rts					
_?L367:						
