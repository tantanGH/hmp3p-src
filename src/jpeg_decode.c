...
int32_t jpeg_decode_init(JPEG_DECODE_HANDLE* jpeg, int16_t brightness, int16_t half_size) {
...
static int32_t jpeg_decode_exec_half(JPEG_DECODE_HANDLE* jpeg, uint8_t* jpeg_buffer, size_t jpeg_buffer_bytes) {
  ...
  int32_t ofs_x = ( 512 - image_info.m_width/2  ) / 2;
