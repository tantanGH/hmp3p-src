...
#define VERSION "0.9.7 (2026/05/31)"

#define MAX_PATH_LEN (256)

#ifdef __mc68060__
#define CONTINUOUS_MP3_BUFFER_BYTES     (8*1024*1024)
#define CONTINUOUS_MP3_INITIAL_BYTES    (8*1024*1024)
#else
...
#define CONTINUOUS_MP3_DRAIN_BYTES      (32*1024)
